...
/**
 * Composable that exposes live MQ connection status.
 * Polling starts when the first subscriber mounts and stops when the last unmounts.
 *
 * @returns {{ resolved: Ref<boolean>, connected: Ref<boolean>, info: Ref<object|null> }}
 */
